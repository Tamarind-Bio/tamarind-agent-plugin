...
The plugin requires `tamarind-cli>=0.4.0` and tests against the latest published release. Treat the executable as a subprocess protocol; do not import its Python modules.
